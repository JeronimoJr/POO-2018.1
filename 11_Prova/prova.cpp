...
public:
    ...
    bool favoritar(string name){
        Contato* contato = getContato(name);
        if(contato->getFavorito() == true){
            throw "contato " + name + " já é favoritado\n";
            return false;
        }
    ...
    bool desfavoritar(string name){
        Contato* contato = getContato(name);
        if(contato->getFavorito() == false){
            throw "contato " + name + " não é favorito\n";
            return false;
        }
...
public:
    ...
    void shell(string line){
        ...
        if(op == "addContato"){
            ...
            string name;
            ss >> name;
            if(agenda.favoritar(name));
                cout << "done" << endl;
        }
        else if(op == "desfav"){
            string name;
            ss >> name;
            if(agenda.desfavoritar(name));
                cout << "done" << endl;
        }
        else if(op == "showFav"){
            cout << agenda.ShowFav();
